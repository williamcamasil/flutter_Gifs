...
class _HomePageState extends State<HomePage> {
  ...
  Future<Map> _getGifs() async {
    ...
    if(_search == null)
      ...
      response = await http.get("https://api.giphy.com/v1/gifs/search?api_key=VjGrTF5xySSgDDs8CZ4wrXgsbA8PCYDr&q=$_search&limit=20&offset=$_offset&rating=G&lang=en");
